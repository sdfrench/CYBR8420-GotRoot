...
Bitwarden, an open-source online password management service, has developed a good reputation for being secure over the years. We knew when we chose this application for our project, it was going to be a big undertaking and there would likely be no "low hanging fruit" given the maturity of the application coupled with the fact it is completely open source and has already been [audited](https://cdn.bitwarden.net/misc/Bitwarden%20Security%20Assessment%20Report%20-%20v2.pdf) by third party security company. 
